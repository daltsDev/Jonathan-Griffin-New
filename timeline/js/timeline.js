...
export default function timeline(e, v) {
  var g = [],
    p = 'Timeline:',
    t = window.innerWidth,
    i = void 0,
  ...
  function s(e) {
    var s, t, i, n, l, a, r;
    (o = e.settings.rtlMode ? (e.items.length > e.settings.visibleItems ? e.items.length - e.settings.visibleItems : 0) : e.settings.startIndex),
      ...
      window.innerWidth > s.settings.forceVerticalMode &&
        ...
        (function () {
          ...
          s.items.forEach(function (e, t) {
            t % 2 == 0
              ? ((e.style.height = l + 'px'), 'bottom' === s.settings.horizontalStartPosition ? (e.classList.add('timeline__item--bottom'), d(e, i)) : e.classList.add('timeline__item--top'))
              : ((e.style.height = n + 'px'), 'bottom' !== s.settings.horizontalStartPosition ? (e.classList.add('timeline__item--bottom'), d(e, i)) : e.classList.add('timeline__item--top'));
          }),
    ...
    [].forEach.call(e, function (e) {
      ...
      Object.keys(b).forEach(function (e) {
        ...
        (r[e] = b[e].defaultValue),
          ...
          'integer' === b[e].type
            ? (r[e] && ((t = r[e]), (i = e), 'number' == typeof t || t % 1 == 0 || (console.warn(p + ' The value "' + t + '" entered for the setting "' + i + '" is not an integer.'), 0))) || (r[e] = b[e].defaultValue)
            : 'string' === b[e].type && b[e].acceptedValues && -1 === b[e].acceptedValues.indexOf(r[e]) && (console.warn(p + ' The value "' + r[e] + '" entered for the setting "' + e + '" was not recognised.'), (r[e] = b[e].defaultValue));
      });
      ...
      if (
        ...
        'px' !== u && '%' !== u && (console.warn(p + " The setting 'verticalTrigger' must be a percentage or pixel value."), (f = !1)),
        '%' === u && (100 < m || m < 0) ? (console.warn(p + " The 'verticalTrigger' setting value must be between 0 and 100 if using a percentage value."), (f = !1)) : 'px' === u && m < 0 && (console.warn(p + " The 'verticalTrigger' setting value must be above 0 if using a pixel value."), (f = !1)),
        !1 === f)
      ) {
      ...
      (r.verticalTrigger = {unit: u, value: m}),
        r.moveItems > r.visibleItems && (console.warn(p + ' The value of "moveItems" (' + r.moveItems + ') is larger than the number of "visibleItems" (' + r.visibleItems + '). The value of "visibleItems" has been used instead.'), (r.moveItems = r.visibleItems)),
        r.startIndex > a.length - r.visibleItems && a.length > r.visibleItems
          ? (console.warn(p + " The 'startIndex' setting must be between 0 and " + (a.length - r.visibleItems) + ' for this timeline. The value of ' + (a.length - r.visibleItems) + ' has been used instead.'), (r.startIndex = a.length - r.visibleItems))
          : a.length <= r.visibleItems
          ? (console.warn(p + " The number of items in the timeline must exceed the number of visible items to use the 'startIndex' option."), (r.startIndex = 0))
          : r.startIndex < 0 && (console.warn(p + " The 'startIndex' setting must be between 0 and " + (a.length - r.visibleItems) + ' for this timeline. The value of 0 has been used instead.'), (r.startIndex = 0)),
